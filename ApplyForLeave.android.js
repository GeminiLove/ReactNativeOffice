...
var REQUEST_URL = "http://api.listome.com/v1/companies/users/leave";

var ApplyForLeaveList = React.createClass({
                ...
                <View>
                    <View style={styles.itemContainer}>
                        ...
                        <View style={styles.listItem}>
                            <Text style={styles.leaveType}>{'类型：' + item.leave_type.name}</Text>
